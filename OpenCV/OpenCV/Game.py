...
def worker1(arg1, arg2):
    ...
    # здесь можно выполнять какую-то работу
    result = arg1 + arg2
...
# создаем два потока
t1 = threading.Thread(target=worker1(1, 2))

t2 = threading.Thread(target=Find(Cap, red_lower, red_upper, blue_lower, blue_upper, min_radius, max_radius, count, track_red_pipticks, track_id, track_blue_pipticks, track_id_blue, red_pipticks_prev_frame, blue_pipticks_prev_frame))
